...
class TemperatureMachine(StateMachine):
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            lcd_line_1 = current_time.strftime("%m/%d %H:%M:%S").ljust(16)[:16] + "\n"
            ...
            if(altCounter < 6):
                ...
                temp_f = int(floor(self.getFahrenheit()))
                lcd_line_2 = (f"Temp: {temp_f}F").ljust(16)[:16] + "\n"
                ...
                state = str(self.current_state.id)
                lcd_line_2 = (f"{state} SP:{sp}F").ljust(16)[:16] + "\n"
